...
public class MinPQ<Key_Class> {
	...
	public void insert(Key_Class x) {
		//TODO: Komplettering. orderOK = false kommer resultera i en extra (onˆdig) heapify i delMin().
		// Vi tog bort orderOK = false i insert samt orderOK = true i swim dÂ det inte behˆvs, orderOK anv‰nds av toss.
	...
	for (int k = count/2; k >= 1; k--) {// √Öterst√§ller heap-egenskapen
	    sink(k);
	}
	orderOK = true;
    }
